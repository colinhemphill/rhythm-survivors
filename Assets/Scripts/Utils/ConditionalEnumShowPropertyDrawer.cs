...
[CustomPropertyDrawer(typeof(ConditionalEnumShowAttribute))]
public class ConditionalEnumShowPropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ConditionalEnumShowAttribute condHAtt = (ConditionalEnumShowAttribute)attribute;
    ...
    private int GetConditionalHideAttributeResult(ConditionalEnumShowAttribute condHAtt, SerializedProperty property)
    {
        int enumValue = 0;
